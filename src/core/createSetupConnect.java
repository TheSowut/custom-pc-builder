 ...
 * @author hp
 */
public class createSetupConnect {
     /**
     * Connect to a sample database
     */
    public String url;
    public Connection conn;
    public createSetupConnect(){
    ...
    public void close(){
        try {
            ...
            Logger.getLogger(createSetupConnect.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public ArrayList<String> select(String[] columns, String table) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                //data 1 Ivan Ivanov Varna Bulgaria abv@abv.bg
                result.add(data);
//                    result.add(rs.getString("city"));
    ...
    public ArrayList<String> createSetup(String[] columns, String motherboard, String graphicsCard, String processor, String psu, String ram, String computerCase, String hdd, String ssd) {
        ArrayList<String> result = new ArrayList<String>();
        String cols = String.join(", ", columns);
        String sql = "INSERT INTO setups (Motherboard, Graphics_Card, Processor, PSU, RAM, HDD, Computer_Case, SSD) VALUES ('" + motherboard + "')" + "('" + graphicsCard + "')" + "('" + processor + "')" + "('" + psu + "')" +
                "('" + ram + "')" + "('" + computerCase + "')" + "('" + hdd + "')" + "('" + ssd + "')";
        System.out.println(sql);
        try {
            Connection openConn = conn;
            Statement stmt  = openConn.createStatement();
