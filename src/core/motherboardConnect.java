...
//                    result.add(rs.getString("city"));
    ...
    public ArrayList<String> add(String[] columns, String manufacturer, String model, String socket, String chipset, String formFactor, String price) {
        ...
        String queryInsertData = "INSERT INTO motherboards (Manufacturer, Model, Socket, Chipset, FormFactor, Price) values ('" + manufacturer + "', '" + model + "', '" + socket + "', '" + chipset + "', '" + formFactor + "', '" + price + "')";
